...
// マイクロコンポーネントのインポート
import PermissionMatrixHeader from '@/components/permissions/PermissionMatrixHeader.vue'
import PermissionRolePanel from '@/components/permissions/PermissionRolePanel.vue'
import PermissionMatrixGrid from '@/components/permissions/PermissionMatrixGrid.vue'
import PermissionUserPanel from '@/components/permissions/PermissionUserPanel.vue'
import PermissionTemplatePanel from '@/components/permissions/PermissionTemplatePanel.vue'
import PermissionInheritancePanel from '@/components/permissions/PermissionInheritancePanel.vue'
import PermissionAuditPanel from '@/components/permissions/PermissionAuditPanel.vue'
import PermissionExportDialog from '@/components/permissions/PermissionExportDialog.vue'
