  ...
  <div class="permission-template">
    ...
    >
      ...
      <el-table :data="currentTemplate?.features" style="width: 100%" max-height="400">
        ...
        <el-table-column prop="featureCategory" label="カテゴリ" width="140">
          <template #default="scope">
...
import * as permissionApi from '@core/api/permissions';
import * as featureApi from '@custom/api/features';
import { departmentAPI as departmentApi } from '@custom/api/departments';
