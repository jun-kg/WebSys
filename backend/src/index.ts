...
import { applySecurity } from './core/middleware/security.js'
import { applyGuestConstraints } from './core/middleware/guestConstraint.js'
import authRoutes from './core/routes/auth.js'
import userRoutes from './custom/routes/users.js'
import companyRoutes from './custom/routes/companies.js'
import departmentRoutes from './custom/routes/departments.js'
import featureRoutes from './custom/routes/features.js'
import permissionRoutes from './core/routes/permissions/index.js'
import logRoutes from './core/routes/logs.js'
import alertRuleRoutes from './core/routes/alertRules.js'
import notificationRoutes from './core/routes/notifications.js'
import statisticsRoutes from './custom/routes/statistics.js'
import permissionInheritanceRoutes from './custom/routes/permissionInheritance.js'
import reportRoutes from './custom/routes/reports.js'
import healthRoutes from './custom/routes/health.js'
import workflowRoutes from './custom/routes/workflow/index.js'
import approvalRoutes from './custom/routes/approval.js'
import departmentTemplateRoutes from './custom/routes/department-templates.js'
import rolePermissionRoutes from './custom/routes/role-permissions.js'
import guestUserRoutes from './custom/routes/guest-users.js'
import bulkOperationsRoutes from './custom/routes/bulk-operations.js'
