...
# Enterprise Commons ドキュメント順序コード付与スクリプト
# フォルダ・ファイル名に順序コードを付与して読み順を明確化

echo -e "\033[0;35m📋 Enterprise Commons ドキュメント順序コード付与開始\033[0m"
...
## 概要
Enterprise Commonsプロジェクトの基本情報集。プロジェクト概要・環境構築・トラブルシューティングなどの基礎資料。
...
## 概要
Enterprise Commonsプロジェクトのシステム設計・アーキテクチャドキュメント集。API仕様・コンポーネント設計・システム概要。
...
## 概要
Enterprise Commonsプロジェクトの機能設計・仕様ドキュメント集。各機能の詳細設計・ワークフロー・企業向け機能。
...
## 概要
Enterprise Commonsプロジェクトのテスト・試験関連ドキュメント集。テスト仕様・実行結果・単体試験。
...
## 概要
Enterprise Commonsプロジェクトの運用・デプロイ関連ドキュメント集。デプロイ手順・運用手順・監視設定。
...
## 概要
Enterprise CommonsプロジェクトのUI・UXデザイン関連ドキュメント集。レスポンシブ対応・デザインガイドライン・UI改善。
...
## 概要
Enterprise Commonsプロジェクトの開発・運用ガイドライン集。開発手順・ベストプラクティス・改善プロセス。
...
## 概要
Enterprise Commonsプロジェクトの各種レポート・分析ドキュメント集。プロジェクト状況・品質・性能・Phase別報告。
