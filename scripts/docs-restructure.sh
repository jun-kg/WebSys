...
# Enterprise Commons ドキュメント構成緊急整理スクリプト
# 作成日: 2025-09-30
...
echo -e "${PURPLE}🚀 Enterprise Commons ドキュメント構成緊急整理開始${NC}"
...
## Overview
Enterprise Commonsプロジェクトのコアドキュメント集。プロジェクト概要・環境構築・トラブルシューティングなどの基本情報。

## Documents

### 🚀 Getting Started
- [プロジェクト概要](README.md) - Enterprise Commonsプロジェクトの全体概要
...
### 🏛️ System Design
- [システム概要](system-overview.md) - Enterprise Commons全体アーキテクチャ
