...
> 📚 **詳細技術仕様**: [MASTER_REFERENCE.md](基本/技術仕様統一.md) を参照してください
...
| ドキュメント | 説明 | 対象者 |
|-------------|------|--------|
| [システムアーキテクチャ](設計/SYSTEM_ARCHITECTURE.md) | 技術スタック、コンポーネント構成、データフロー | 開発者、アーキテクト |
...
| ドキュメント | 説明 | 対象者 |
|-------------|------|--------|
| [セットアップガイド](setup/概要.md) | 初回環境構築手順 | すべての開発者 |
...
| ドキュメント | 説明 | 対象者 |
|-------------|------|--------|
| [デプロイガイド](運用/DEPLOYMENT_GUIDE.md) | 環境別デプロイ手順、監視設定 | DevOps、運用担当者 |
...
1. **[システムアーキテクチャ](設計/SYSTEM_ARCHITECTURE.md)** - 全体設計
2. **[デプロイガイド](運用/DEPLOYMENT_GUIDE.md)** - インフラ設計
3. **[環境設計書](../ENVIRONMENT_DESIGN.md)** - 環境構成

### 🔧 DevOps・運用担当者

1. **[デプロイガイド](運用/DEPLOYMENT_GUIDE.md)** - デプロイ・監視
2. **[トラブルシューティング](operations/TROUBLESHOOTING.md)** - 運用・保守
3. **[システムアーキテクチャ](設計/SYSTEM_ARCHITECTURE.md)** - 技術理解
...
3. **[システムアーキテクチャ](設計/SYSTEM_ARCHITECTURE.md)** - データベース・認証
...
- [開発環境デプロイ](運用/DEPLOYMENT_GUIDE.md#ローカル開発環境)
- [ステージング環境](運用/DEPLOYMENT_GUIDE.md#ステージング環境)
- [本番環境](運用/DEPLOYMENT_GUIDE.md#本番環境)
- [監視・アラート](運用/DEPLOYMENT_GUIDE.md#監視・アラート)
...
> 📊 **詳細進捗**: [水平展開実装計画](./66-水平展開実装計画.md) | [ドキュメント改善計画](報告/document-comprehensive-review.md)
...
**📊 技術仕様**: [MASTER_REFERENCE.md](基本/技術仕様統一.md) で一元管理
**📧 管理者**: システム設計チーム