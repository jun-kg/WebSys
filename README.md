...
> **✅ プロジェクト名称変更完了（2025-10-18）**
>
> **旧名**: `websys` → **新名**: `enterprise-commons`（企業共通基盤）
>
> - ✅ ローカルディレクトリ名を変更済み
> - ✅ ドキュメント・スクリプトをすべて更新済み
> - ⏸️ GitHubリポジトリ名は現状維持（`WebSys`）
>
> 詳細は [プロジェクト名称変更ガイド](docs/PROJECT_RENAMING_GUIDE.md) を参照してください。
